document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    ru: {
      ...
      aboutTitle: "О мастере", aboutText: "Привет! Я MORK. Для меня татуировка — это не просто рисунок на коже, а форма самовыражения и отражение вашей внутренней эстетики. Работаю как по уникальным авторским эскизам, так и воплощаю идеи клиентов.",
    ...
    en: {
      ...
      aboutTitle: "About the Artist", aboutText: "Hi! I'm MORK. To me, a tattoo is more than skin art — it's a statement of self-expression and aesthetics. I create unique custom designs as well as bring your personal ideas to life.",
    ...
    pl: {
      ...
      aboutTitle: "O artyście", aboutText: "Cześć! Jestem MORK. Tatuaż to dla mnie coś więcej niż rysunek na skórze — to forma wyrażenia siebie i Twojej estetyki. Tworzę autorskie projekty oraz realizuję pomysły klientów.",
    ...
    de: {
      ...
      aboutTitle: "Über den Künstler", aboutText: "Hallo! Ich bin MORK. Tattoo ist für mich mehr als nur Zeichnung auf der Haut — es ist Selbstausdruck. Ich erstelle individuelle Designs und setze deine Ideen um.",
    ...
    ua: {
      ...
      aboutTitle: "Про майстра", aboutText: "Привіт! Я MORK. Для мене татуювання — це не просто малюнок на шкірі, а форма самовираження та відображення вашої естетики. Працюю за авторськими ескізами та втілюю ідеї клієнтів.",
